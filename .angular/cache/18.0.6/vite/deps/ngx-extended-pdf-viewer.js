...
var pdfjsVersion = "4.4.698";
var pdfjsBleedingEdgeVersion = "4.4.697";
...
var NgxConsole = class _NgxConsole {
  static init() {
    ...
    if (!globalThis["ngxConsole"]) {
      globalThis["ngxConsole"] = new _NgxConsole();
    }
  }
  log(message, reason) {
    ...
    return __async(this, null, function* () {
      ...
      return new Promise((resolve) => __async(this, null, function* () {
        (() => __async(this, null, function* () {
          ...
          yield this.loadCoreLibrary();
          yield this.loadViewer();
          resolve(this.PDFViewerApplication !== void 0);
        }))();
      }));
    });
  }
