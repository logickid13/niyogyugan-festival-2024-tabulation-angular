...
LoadingBarService.ɵfac = function LoadingBarService_Factory(ɵt) {
  return new (ɵt || LoadingBarService)(ɵɵinject(PLATFORM_ID), ɵɵinject(LOADING_BAR_CONFIG, 8), ɵɵinject(NgZone, 8));
};
...
LoadingBarComponent.ɵfac = function LoadingBarComponent_Factory(ɵt) {
  return new (ɵt || LoadingBarComponent)(ɵɵdirectiveInject(LoadingBarService));
};
...
LoadingBarModule.ɵfac = function LoadingBarModule_Factory(ɵt) {
  return new (ɵt || LoadingBarModule)();
};
...
//# sourceMappingURL=chunk-FQHISFSN.js.map
