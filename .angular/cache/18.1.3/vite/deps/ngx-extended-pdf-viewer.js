...
var _c5 = ":host:focus{outline:none}button:focus{outline:none}svg:focus{outline:none}button{padding:0;margin-top:0;margin-bottom:0}.width-height-23px{width:23px;height:23px}\n";
...
var _c13 = "[_nghost-%COMP%]:focus{outline:none}button[_ngcontent-%COMP%]:focus{outline:none}svg[_ngcontent-%COMP%]:focus{outline:none}button[_ngcontent-%COMP%]{padding:0;margin-top:0;margin-bottom:0}";
var FindState;
(function(FindState2) {
...
var pdfjsVersion = "4.5.708";
var pdfjsBleedingEdgeVersion = "4.5.760";
...
var NgxExtendedPdfViewerComponent = class _NgxExtendedPdfViewerComponent {
  ...
  adjustCenterColumnInToolbar() {
    const container = document.querySelector("#toolbarViewer");
    const leftColumn = document.querySelector("#toolbarViewer #toolbarViewerLeft");
    const rightColumn = document.querySelector("#toolbarViewer #toolbarViewerRight");
    const centerColumn = document.querySelector("#toolbarViewer #toolbarViewerMiddleContainer");
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function NgxExtendedPdfViewerComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵtemplate(5, NgxExtendedPdfViewerComponent_ng_content_5_Template, 1, 0, "ng-content", 8)(6, NgxExtendedPdfViewerComponent_ng_template_6_Template, 65, 93, "ng-template", null, 1, ɵɵtemplateRefExtractor)(8, NgxExtendedPdfViewerComponent_ng_template_8_Template, 0, 0, "ng-template", null, 2, ɵɵtemplateRefExtractor);
      }
      if (rf & 2) {
