import {
  DomSanitizer
} from "./chunk-CDSAVQUR.js";
import {
  FormsModule,
  NgSelectOption,
  ɵNgSelectMultipleOption
} from "./chunk-PN6ZPFVM.js";
import "./chunk-3LJ2ZMA7.js";
import {
  AsyncPipe,
  CommonModule,
  DOCUMENT,
...
var pdfjsVersion = "4.4.717";
var pdfjsBleedingEdgeVersion = "4.5.689";
...
var pdfDefaultOptions = {
  ...
  enableHWA: true
  // enable hardware acceleration. Active since pdf.js 4.4. This is the opposite of activateWillReadFrequentlyFlag
};
var ScrollModeType;
...
var NgxExtendedPdfViewerService = class _NgxExtendedPdfViewerService {
  ...
  print(printRange) {
    if (this.PDFViewerApplication) {
      const alreadyThere = this.PDFViewerApplication?.PDFPrintServiceFactory?.isInPDFPrintRange !== void 0;
      if (!alreadyThere) {
        if (!printRange) {
          printRange = {};
        }
...
`;
  ...
  ensurePdfJsHasBeenLoaded() {
    return __async(this, null, function* () {
      if (this.PDFViewerApplication) {
        return true;
      }
      this._needsES5 = yield this.needsES5();
      yield this.loadViewer();
  ...
  needsES5() {
    return __async(this, null, function* () {
      ...
      if (this._needsES5 === void 0) {
        ...
        this._needsES5 = !(yield this.ngxExtendedPdfViewerCanRunModernJSCode());
      }
...
var NgxKeyboardManagerService = class _NgxKeyboardManagerService {
  ...
  unregisterKeyboardListener() {
    ...
    this.PDFViewerApplicationOptions = void 0;
  }
...
var PdfZoomInComponent = class _PdfZoomInComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 2,
    vars: 5,
    consts: [["primaryToolbarId", "primaryZoomIn", "title", "Zoom In", "l10nId", "pdfjs-zoom-in-button", "l10nLabel", "pdfjs-zoom-in-button-label", "eventBusName", "zoomin", "image", "<svg width='24px' height='24px' viewBox='0 0 24 24'><path fill='currentColor' d='M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z' /></svg>", 1, "zoomIn", 3, "cssClass", "order"]],
...
var PdfZoomOutComponent = class _PdfZoomOutComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 2,
    vars: 5,
    consts: [["primaryToolbarId", "primaryZoomOut", "title", "Zoom Out", "l10nId", "pdfjs-zoom-out-button", "l10nLabel", "pdfjs-zoom-out-button-label", "eventBusName", "zoomout", "image", "<svg width='24px' height='24px' viewBox='0 0 24 24'><path fill='currentColor' d='M19,13H5V11H19V13Z' /></svg>", 1, "zoomOut", 3, "cssClass", "order"]],
  ...
  ngOnInit() {
    return __async(this, null, function* () {
      ...
      if (isPlatformBrowser(this.platformId)) {
        ...
        yield this.pdfScriptLoaderService.ensurePdfJsHasBeenLoaded();
